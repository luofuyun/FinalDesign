...
<script type="text/javascript" src="../js/showDefaultItems.js"></script>
</head>
<body>
<c:choose>
					...
					<div class="ui-datatable-tablewrapper" style="margin-top: 5px;">
						<table id="mytable" > 
							<tr align="center"> 
				    			...
				    			<th scope="col" abbr="Dual 1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;添加者</th>
				    			<th scope="col" abbr="Dual 2">&nbsp;&nbsp;&nbsp;&nbsp;操&nbsp;&nbsp;作</th>
				 			</tr>
							<c:forEach var="tempdefaultitem" items="${defaultitemlist}" varStatus="tempStatus">
								<tr align="center">
							     <td align="center">${tempdefaultitem.course.courseName}</td>
	                             <td>${tempdefaultitem.topic}</td>
	                             <td>${tempdefaultitem.chapter}</td>
	                             <td>${tempdefaultitem.description}</td>
	                             <td>${tempdefaultitem.creator.userName}</td>
	                          <td>
	                     <button class="btn btn-primary" onclick="toShowDefaultItem('${tempitem.itemId}')">查看更多信息</button>
						 </td>
								 </tr>
							</c:forEach>
						</table>
