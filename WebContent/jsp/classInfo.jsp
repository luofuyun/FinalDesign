...
<script type='text/javascript' src='<%=path%>/js/classInfo.js'></script>
<script type="text/javascript">
</script>
   ...
   <jsp:include page="StudentPublicJsp.jsp" />
	...
	<div id="zan-bodyer">
		<div class="container">
			...
			<div id="btn-css">
				<center>
					<form id="classForm" name="classForm" method="post" action="">
						...
						<table style="font-size: 15px;border: none;" cellpadding="5" cellspacing="5" >
							...
							<tr>
								<td><font style="color: red;"> * </font>班&nbsp; 级&nbsp;名:</td>
								<td><input type="text" id="className" name="className" value="${student.accountId}"/></td>
							...
							<tr>
								...
								<td><text id="save_button" name="save_button"
										...
										onclick="modifyClassInfo()" type="submit">
										保存
									</text>&nbsp;&nbsp;&nbsp;
